...
public class ICAOAnnex14SurfaceStrip extends ICAOAnnex14Surface {
    ...
    @Builder
    public ICAOAnnex14SurfaceStrip(Long id, ICAOAnnex14RunwayClassifications classification, ICAOAnnex14RunwayCategories category, ICAOAnnex14RunwayCodeNumbers code, Double length, Double width) {
