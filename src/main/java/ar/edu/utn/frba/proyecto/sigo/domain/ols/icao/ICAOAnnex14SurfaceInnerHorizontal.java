...
public class ICAOAnnex14SurfaceInnerHorizontal extends ICAOAnnex14Surface {
    ...
    @Builder
    public ICAOAnnex14SurfaceInnerHorizontal(Long id, ICAOAnnex14RunwayClassifications classification, ICAOAnnex14RunwayCategories category, ICAOAnnex14RunwayCodeNumbers code, Double height, Double radius) {
