...
public class ICAOAnnex14SurfaceApproachFirstSection extends ICAOAnnex14Surface {
    ...
    @Builder
    public ICAOAnnex14SurfaceApproachFirstSection(Long id, ICAOAnnex14RunwayClassifications classification, ICAOAnnex14RunwayCategories category, ICAOAnnex14RunwayCodeNumbers code, Double length, Double slope) {
