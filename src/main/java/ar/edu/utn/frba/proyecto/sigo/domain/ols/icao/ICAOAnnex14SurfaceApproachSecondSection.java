...
@Data
public class ICAOAnnex14SurfaceApproachSecondSection
    ...
    implements ObstacleLimitationSurface<Polygon>
{
    ...
    @Builder
    public ICAOAnnex14SurfaceApproachSecondSection(Long id, ICAOAnnex14RunwayClassifications classification, ICAOAnnex14RunwayCategories category, ICAOAnnex14RunwayCodeNumbers code, Polygon geometry, Double length, Double slope) {
