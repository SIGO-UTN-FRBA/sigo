...
public class ICAOAnnex14SurfaceBalkedLanding extends ICAOAnnex14Surface {
    ...
    @Builder
    public ICAOAnnex14SurfaceBalkedLanding(Long id, ICAOAnnex14RunwayClassifications classification, ICAOAnnex14RunwayCategories category, ICAOAnnex14RunwayCodeNumbers code, Double lengthOfInnerEdge, Double distanceFromThreshold, Double divergence, Double slope) {
